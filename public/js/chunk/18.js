...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteItemConfirm: function deleteItemConfirm() {
      this.salaries.splice(this.editable.index, 1);
      this.close('confirm');
    },
    ...
    close: function close(key) {
      ...
      this.$nextTick(function () {
        _this.editable.item = _objectSpread({}, salary);
        _this.editable.index = -1;
      });
    },
    save: function save() {
      this.editable.index > -1 ? Object.assign(this.salaries[this.editable.index], this.editable.item) : this.salaries.push(this.editable.item);
      this.close('dialog');
    }
  },
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c(
                              ...
                              [
                                _c("v-text-field", {
                                  attrs: { label: "Employee name" },
                                  model: {
                                    value: _vm.editable.item.employee_name,
                                    callback: function($$v) {
                                      _vm.$set(
                                        _vm.editable.item,
                                        "employee_name",
                                    ...
                                    expression: "editable.item.employee_name"
                                  }
                                }),
                                _vm._v(" "),
                                _c("v-text-field", {
                                  attrs: { label: "Amount" },
                                  model: {
                                    value: _vm.editable.item.amount,
                                    callback: function($$v) {
                                      _vm.$set(_vm.editable.item, "amount", $$v)
                                    },
                                    expression: "editable.item.amount"
                                  }
                                }),
                                _vm._v(" "),
                                _c(
